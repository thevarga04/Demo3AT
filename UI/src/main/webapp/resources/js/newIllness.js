...
let urlSave       = "http://localhost:38001/api/saveIllness";
...
function createIllnessUI() {
  ...
  textarea.rows = 6;
  textarea.placeholder = "Insert some text describing the illness";
...
function pageButtons() {
  ...
  save_button.onclick = function(){ SaveIllness() };
